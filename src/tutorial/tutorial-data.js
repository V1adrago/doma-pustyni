...
export const UNIT_GUIDE = {
  ...
  scout: {
    ...
    counter: 'Остановить Клинком, Гвардейцем или башней со стрелковой поддержкой.',
    tip: 'Отряд из 2. Скорость — главное преимущество.',
  },
  swordsman: {
    role: 'Базовая пехота',
    category: 'melee',
    ...
    counter: 'Латник и Пикейщик превосходят Клинка в прямом столкновении.',
    tip: 'Отряд 3. Дёшев и эффективен в связке.',
  },
  assault: {
    role: 'Осада башен',
    category: 'assault',
