...
export const TUTORIAL_LESSONS = [
  {
    ...
    steps: [
      ...
      {
        title: 'Выставь юнита',
        text: 'Поставь Клинка Дома (⚔) или Ищейку Барханов (⚡) на центральную линию. Юниты идут вперёд и атакуют всё на своём пути.',
        highlightCards: ['swordsman', 'scout'],
        requireCardPlay: true,
      },
      {
        title: 'Инженер Узла',
        text: 'Инженер не воюет — он идёт к центральному узлу ресурсов и увеличивает доход специй. Выставь его на центральную линию.',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'Противник поставил Стрелка (⛶). Выставь Ищейку Барханов (⚡) или Клинка Дома (⚔) — они добегут до него раньше, чем он накопит урон.',
        highlightCards: ['scout', 'swordsman', 'guard'],
        requireCardPlay: true,
      },
      {
        title: 'Против брони',
        text: 'Противник поставил Латника (тяжёлый юнит). Лучший ответ — Пикейщик: у него бонусный урон по бронированным целям.',
        highlightCards: ['spearman', 'archer'],
        requireCardPlay: true,
      },
      {
        title: 'Связка: танк первым',
        text: 'Для сноса башни нужна связка. Сначала выставь Латника (🛡) или Стража — они принимают удары башни на себя.',
        highlightCards: ['heavy', 'guard'],
        requireCardPlay: true,
      },
      {
        title: 'Башнелом в атаку',
        text: 'Теперь выставь Башнелома (⚒) следом — он нанесёт огромный урон башне, пока танк отвлекает огонь. Вместе они непробиваемы.',
        highlightCards: ['assault'],
        requireCardPlay: true,
      },
      {
        title: 'Поддержка',
        text: 'Стрелок за связкой добивает остатки и отбивает подоспевших защитников. Держи давление — не давай врагу восстановиться.',
